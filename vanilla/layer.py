...
class Layer:
    ...
    def forward_propagate(self):
        matrix_times_vec(self.weights, self.prev_layer.output, self.total_input)
        sigmoid(self.total_input, self.output)
    ...
    def deriv_wrt_unit_total_inputs(self):
        ...
        for i, ipt in enumerate(self.total_input):
            deriv_wrt_unit_input = derivative_of_sig(ipt) * deriv_wrt_unit_outputs[i]
